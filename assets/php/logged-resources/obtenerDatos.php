...
$sql = "SELECT peso, altura, imc, obj_kcal, obj_fisico, nombre, apellido, registro_confirmado FROM usuario WHERE id_usuario = $id_usuario";
...
if ($result->num_rows > 0) {
    ...
    echo json_encode([
        ...
        'registro_confirmado' => $datos['registro_confirmado']
    ]);
} else {
